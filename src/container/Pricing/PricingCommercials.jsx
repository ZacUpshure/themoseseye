...
const sections = [
  {
    name: 'Features',
    features: [
      { name: 'Commercial Time', tiers: { Basic: '30s', Essential: '60s', Premium: '90s' } },
      { name: 'Scriptwriting', tiers: { Basic: 'assistance', Essential: 'custome', Premium: 'custome & concept development' } },
      { name: 'Locations', tiers: { Basic: '1 locations', Essential: '2 locations', Premium: 'multiple locations' } },
      { name: 'Post-productions', tiers: { Basic: 'editing and post-production', Essential: 'editing and post-production with color grading', Premium: 'editing and post-production with advanced effects and motion graphics' } },
      { name: 'Background music', tiers: { Basic: 'Royalty-free background music', Essential: 'Licensed background music and sound effects', Premium: 'Licensed background music, sound effects, and voice-over (provided by the company)' } },
      { name: 'Actors', tiers: { Premium: 'actors or models (up to 2)' } },
