...
const sections = [
  {
    name: 'Features',
    features: [
      { name: 'Pages', tiers: { Basic: '5', Essential: '10', Premium: '20' } },
      { name: 'Contact form', tiers: { Basic: true, Essential: true, Premium: true } },
      { name: 'Responsive Design', tiers: { Basic: true, Essential: true, Premium: true } },
      { name: 'Content-Management-System', tiers: { Essential: true, Premium: true } },
      { name: 'Revisions', tiers: { Basic: '1', Essential: '2', Premium: '3' } },
      { name: 'Technical-SEO', tiers: { Basic: true, Essential: true, Premium: true } },
      { name: 'On-Page-SEO', tiers: { Basic: true, Essential: true, Premium: true } },
      { name: 'Off-Page-SEO', tiers: { Premium: true } },
      { name: 'Google Analytics-Integration', tiers: { Essential: true, Premium: true } },
      { name: 'A/B-Tests und Conversion-Rate-Optimization', tiers: { Premium: true } },
      { name: 'Animations', tiers: { Premium: true } },
      { name: 'Authentication and Payment Processing', tiers: { Premium: true } },
    ],
  },
  {
    name: 'Additional Technical Services (on request)',
    features: [
      { name: 'Serverless API', tiers: {  } },
      { name: 'Database', tiers: {  } },
      { name: 'Maintainance Support', tiers: {  } },
    ],
  },
]
