...
import { PricingCommercials, RealFooter } from '../container';
...
const Videography = () => {
  return (
    <article>
        <div>
            <Banner img={profile.videography} />

            {/* Content section */}
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8 pb-7">
          <div className="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
            <div className="w-full lg:max-w-lg lg:flex-auto">
              ...
              <img
                src="https://images.unsplash.com/photo-1584224549374-995cbac1ab62?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2792&q=80"
                alt=""
